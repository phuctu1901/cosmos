...
use crate::msg::{HandleMsg, InitMsg, MintMsg, MinterResponse, QueryMsg, AddTransactionMsg};
use crate::state::{
...
pub fn handle<S: Storage, A: Api, Q: Querier>(
    ...
    match msg {
        ...
        HandleMsg::AddTransaction(msg) => handle_add_transaction(deps, env, info, msg),
...
pub fn handle_add_transaction<S: Storage, A: Api, Q: Querier>(
    deps: &mut Extern<S, A, Q>,
    _env: Env,
    info: MessageInfo,
    ...
    let transaction = TransactionInfo {
        user_id: deps.api.canonical_address(&msg.user_id)?,
        ...
        experts_output_data: msg.experts_output_data,
        status: msg.status
    };
